...
% Functions
[r_dot_vec_L, r_vec_L] = Radius313Euler_to_NPositionVelocity_Name(r_mars,RAAN_L,i_L,nu_fin_L,mu);
[r_dot_vec_G, r_vec_G] = Radius313Euler_to_NPositionVelocity_Name(r_mars,RAAN_G,i_G,nu_fin_G,mu);
